...
echo "<div class='container-fluid padding postloginpage'>
        <div class='row aboutwelcome text-center'>
            <div class='col-12 myabouttext'>
                <h1 class='display-4'>My Files <i class='fas fa-file-image fa-sm'></i></h1>
                <hr>
                <h3>View image files that your personal trainer has sent to you.</h3>
                <div class='col-12'>  
                </div>
            </div>
        </div>
    ...
    while($row = $result->fetch_assoc()){
        ...
        echo "
        <a href='uploadedfiles/$path'</a>
        <table style = 'width:100%'> 
        <tr>
        <th style = 'text-align:center'><button type='submit' name = 'viewfile' class='btn btn-lg btn-warning'>VIEW LINK</button></th>
        </tr>
        </table>
        <br>";
