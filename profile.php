            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link grow" href="editprofile.php">EDIT PROFILE</a>
                    </li>
                    <li class="nav-item">
   ...
   <div class="container-fluid padding postloginpage">
        <div class="row aboutwelcome text-center">
            <div class="col-12 myabouttext">
                <h1 class="display-4">Current Profile <i class="fas fa-user"></i></h1>
                <h3 id = "youarelogged">Edit this data as your profile changes over time.</h3>
                <hr>
                <div class="col-12">
        ...
        while($row = $result->fetch_assoc()){
            ...
            <a href='editprofile.php' style='text-decoration:none; color:black'>EDIT PROFILE</a></button>
        </div>
            <div class='col-sm-12 col-md-4 mytrack'>
